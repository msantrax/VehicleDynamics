...
ALTER TABLE CLASSTEMP DROP FOREIGN KEY classtemp_dono_fk ;
ALTER TABLE CLASSTEMP FOREIGN KEY classtemp_grupos_fk ;
...
INSERT INTO USERS (LOGIN,NOME,SENHA,GRUPO,SECRET,RESPOSTA,COMENT) VALUES ('antrax','Antrax Tecnologia','00000',0,'Pergunta1','Resposta','Administrador');
INSERT INTO USERS (LOGIN,NOME,SENHA,GRUPO,SECRET,RESPOSTA,COMENT) VALUES ('ewerton','Ewerton Mecati','00000',0,'Pergunta1','Resposta','Administrador');
INSERT INTO USERS (LOGIN,NOME,SENHA,GRUPO,SECRET,RESPOSTA,COMENT) VALUES ('jader','Jader Nogueira','00000',0,'Pergunta1','Resposta','Administrador');
...
UPDATE USERS U SET U.GRUPO = (SELECT G.ID FROM GRUPOS G WHERE G.NOME = 'Manutencao') WHERE U.GRUPO = 0;
UPDATE USERS U SET U.GRUPO = (SELECT G.ID FROM GRUPOS G WHERE G.NOME = 'Usuarios') WHERE U.GRUPO = 1;
UPDATE USERS U SET U.GRUPO = (SELECT G.ID FROM GRUPOS G WHERE G.NOME = 'Admin') WHERE U.GRUPO = 2;
...
INSERT INTO CLASSMAP (NODE,PARENT,TIPO,DTBLK,DTBLF,DONO,GRUPO,PERM,COMENT) VALUES ('Programas',
    ...
    INSERT INTO CLASSMAP (NODE,PARENT,TIPO,DTBLK,DTBLF,DONO,GRUPO,PERM,COMENT) VALUES ('Fiat',
...
INSERT INTO CLASSMAP (NODE,PARENT,TIPO,DTBLK,DTBLF,DONO,GRUPO,PERM,COMENT) VALUES ('Normas',
    ...
    INSERT INTO CLASSMAP (NODE,PARENT,TIPO,DTBLK,DTBLF,DONO,GRUPO,PERM,COMENT) VALUES ('Varga',
        ...
        (SELECT U.GRUPO FROM USERS U WHERE U.LOGIN = 'antrax'),
        777,  'Normas EPA');
    INSERT INTO CLASSMAP (NODE,PARENT,TIPO,DTBLK,DTBLF,DONO,GRUPO,PERM,COMENT) VALUES ('Bendix',
        (SELECT C.ID FROM CLASSMAP C WHERE C.NODE = 'Normas'),
        21,
        '',0,
        (SELECT U.ID FROM USERS U WHERE U.LOGIN = 'antrax') ,
