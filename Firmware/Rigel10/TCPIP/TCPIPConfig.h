...
#define MY_DEFAULT_GATE_BYTE4           (14ul)

#define MY_DEFAULT_PRIMARY_DNS_BYTE1	(200ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE2	(204ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE3	(0ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE4	(10ul)

#define MY_DEFAULT_SECONDARY_DNS_BYTE1	(200ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE2	(204ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE3	(0ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE4	(168ul)
