 ...
 * @author antrax
 */
public class DisplayCounter extends javax.swing.JPanel implements MDisplay{
    ...
    public DisplayCounter(String header, String format, String unit, Font display_font) {
    ...
    public void commitDisplay(){
        ...
        counter_type = splits[0].toUpperCase();
        format = splits[1];
    ...
    public void setValue(double value){     
        ...
        if (value == -1){
            ...
            String output = myFormatter.format(counts);
            VarValue.setText(output);  
            return;
        }
        
        if (counter_type.equals("RAISE")){
            if (value == 1){
                if (last_value==0){
                    counts++;
                    last_value = 1;
        ...
        else if (counter_type.equals("FALL")){
            if (value == 0){
                if (last_value==1){
                    counts++;
                    last_value = 0;
    ...
    private void initComponents() {
        ...
        VarValue.setText(org.openide.util.NbBundle.getMessage(DisplayCounter.class, "DisplayCounter.VarValue.text")); // NOI18N
